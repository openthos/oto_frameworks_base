...
static void nativeSetBlurCrop(JNIEnv* env, jclass clazz, jlong nativeObject,
        jint l, jint t, jint r, jint b) {
    SurfaceControl* const ctrl = reinterpret_cast<SurfaceControl *>(nativeObject);
    Rect crop(l, t, r, b);
    status_t err = ctrl->setBlurCrop(crop);
    if (err < 0 && err != NO_INIT) {
        doThrowIAE(env);
    }
}
...
static const JNINativeMethod sSurfaceControlMethods[] = {
    ...
    {"nativeSetBlurCrop", "(JIIII)V",
            (void*)nativeSetBlurCrop },
