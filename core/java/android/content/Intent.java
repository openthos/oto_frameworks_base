...
public class Intent implements Parcelable, Cloneable {
    ...
    //@SdkConstant(SdkConstantType.ACTIVITY_INTENT_ACTION)
    //public static final String ACTION_STARTMENU_SEND_SQLITE_INFO
    //                      = "com.android.startupmenu.SQLITE_CHANGE";
    /**
    ...
    public static final String EXTRA_DESKTOP_BACK = "Backspace";
   ...
   /**
    ...
    public static final String STATUS_BAR_INFO_HIDE_CUSTOM =
                                      "android.intent.statusbar.info.hide.custom";
    public static final String STATUS_BAR_INFO_SHOW_CUSTOM =
                                      "android.intent.statusbar.info.show.custom";
    public static final String STATUS_BAR_WIFI_ICON =
