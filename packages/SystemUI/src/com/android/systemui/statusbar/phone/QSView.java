...
public class QSView extends LinearLayout {
    ...
    public QSView(Context context,  AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    }

    public QSView(Context context,  AttributeSet attrs, int defStyleAttr) {
