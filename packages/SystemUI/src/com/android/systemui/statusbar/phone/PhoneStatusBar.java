...
import com.android.systemui.statusbar.policy.SettingControllerImpl;
...
public class PhoneStatusBar extends BaseStatusBar implements DemoMode,
    ...
    SettingControllerImpl mSettingController;
    ...
    protected PhoneStatusBarView makeStatusBarView() {
        ...
        if (mQSPanel != null) {
            final QSTileHost qsh = new QSTileHost(mContext, this,
                    ...
                    mSecurityController, mScreenshotController, mSettingController);
    ...
    public View dialogViewHide() {
        ...
        if (mClicked) {
            ...
            showText.setTextColor(Color.parseColor(TEXT_COLOR_GRAY));
        }
        dialogView.setFocusable(true);
        hideText.setOnHoverListener(hideShowHover);
        ...
        showText.setOnHoverListener(hideShowHover);
    ...
    */ }
    ...
    private void updateEmptyShadeView() {
        ...
        mNotificationPanel.setShadeEmpty(true);
    }
   ...
   public void removeLockedIcon(String pkg) {
    ...
    public void setSystemUiVisibility(int vis, int mask) {
        ...
        if (diff != 0) {
            ...
            final boolean nbModeChanged = false;
